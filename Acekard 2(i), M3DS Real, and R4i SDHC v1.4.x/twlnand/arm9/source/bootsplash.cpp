...
void BootSplashDSi() {
	...
	swiDecompressLZSSVram ((void*)DSi01Tiles, (void*)CHAR_BASE_BLOCK(2), 0, &decompressBiosCallback);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)BotDSi00Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	vramcpy_ui (&BG_PALETTE[0], DSi02Pal, DSi02PalLen);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], BotDSi01Pal, BotDSi01PalLen); }

	for (int i = 0; i < 2; i++) { swiWaitForVBlank(); }
	
	swiDecompressLZSSVram ((void*)DSi01Tiles, (void*)CHAR_BASE_BLOCK(2), 0, &decompressBiosCallback);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)BotDSi01Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	vramcpy_ui (&BG_PALETTE[0], DSi02Pal, DSi02PalLen);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], BotDSi02Pal, BotDSi02PalLen); }
	
	for (int i = 0; i < 2; i++) { swiWaitForVBlank(); }
	
	swiDecompressLZSSVram ((void*)DSi02Tiles, (void*)CHAR_BASE_BLOCK(2), 0, &decompressBiosCallback);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)BotDSi02Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	vramcpy_ui (&BG_PALETTE[0], DSi03Pal, DSi03PalLen);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], BotDSi03Pal, BotDSi03PalLen); }
	
	for (int i = 0; i < 2; i++) { swiWaitForVBlank(); }

	swiDecompressLZSSVram ((void*)DSi03Tiles, (void*)CHAR_BASE_BLOCK(2), 0, &decompressBiosCallback);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)BotDSi03Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	vramcpy_ui (&BG_PALETTE[0], DSi03Pal, DSi03PalLen);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], BotDSi03Pal, BotDSi03PalLen); }
	...
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)BotDSi04Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	vramcpy_ui (&BG_PALETTE[0], DSi04Pal, DSi04PalLen);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], BotDSi04Pal, BotDSi04PalLen); }

	for (int i = 0; i < 2; i++) { swiWaitForVBlank(); }

	swiDecompressLZSSVram ((void*)DSi05Tiles, (void*)CHAR_BASE_BLOCK(2), 0, &decompressBiosCallback);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)BotDSi05Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	vramcpy_ui (&BG_PALETTE[0], DSi05Pal, DSi05PalLen);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], BotDSi05Pal, BotDSi05PalLen); }
	...
	if(REG_SCFG_MC == 0x11) { 
		if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) {
	...
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)BotDSi06Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	vramcpy_ui (&BG_PALETTE[0], DSi29Pal, DSi29PalLen);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], BotDSi06Pal, BotDSi06PalLen); }

	for (int i = 0; i < 2; i++) { swiWaitForVBlank(); }

	swiDecompressLZSSVram ((void*)DSi30Tiles, (void*)CHAR_BASE_BLOCK(2), 0, &decompressBiosCallback);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)BotDSi07Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	vramcpy_ui (&BG_PALETTE[0], DSi30Pal, DSi30PalLen);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], BotDSi07Pal, BotDSi07PalLen); }

	for (int i = 0; i < 2; i++) { swiWaitForVBlank(); }

	swiDecompressLZSSVram ((void*)DSi31Tiles, (void*)CHAR_BASE_BLOCK(2), 0, &decompressBiosCallback);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)BotDSi08Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	vramcpy_ui (&BG_PALETTE[0], DSi31Pal, DSi31PalLen);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], BotDSi08Pal, BotDSi08PalLen); }

	for (int i = 0; i < 2; i++) { swiWaitForVBlank(); }
	
	swiDecompressLZSSVram ((void*)DSi32Tiles, (void*)CHAR_BASE_BLOCK(2), 0, &decompressBiosCallback);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)BotDSi09Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	vramcpy_ui (&BG_PALETTE[0], DSi32Pal, DSi32PalLen);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], BotDSi09Pal, BotDSi09PalLen); }

	for (int i = 0; i < 2; i++) { swiWaitForVBlank(); }
	
	swiDecompressLZSSVram ((void*)DSi33Tiles, (void*)CHAR_BASE_BLOCK(2), 0, &decompressBiosCallback);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)BotDSi10Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	vramcpy_ui (&BG_PALETTE[0], DSi33Pal, DSi33PalLen);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], BotDSi10Pal, BotDSi10PalLen); }

	for (int i = 0; i < 2; i++) { swiWaitForVBlank(); }	

	swiDecompressLZSSVram ((void*)DSi34Tiles, (void*)CHAR_BASE_BLOCK(2), 0, &decompressBiosCallback);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)BotDSi11Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	vramcpy_ui (&BG_PALETTE[0], DSi34Pal, DSi34PalLen);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], BotDSi11Pal, BotDSi11PalLen); }
	...
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], BotDSi00Pal, BotDSi00PalLen); }
...
void BootSplashDS() {
	...
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)Bot01Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	vramcpy_ui (&BG_PALETTE[0], Top02Pal, Top02PalLen);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], Bot02Pal, Bot02PalLen); }
	
	for (int i = 0; i < 2; i++) { swiWaitForVBlank(); }
	
	swiDecompressLZSSVram ((void*)Top02Tiles, (void*)CHAR_BASE_BLOCK(2), 0, &decompressBiosCallback);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)Bot02Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	vramcpy_ui (&BG_PALETTE[0], Top03Pal, Top03PalLen);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], Bot03Pal, Bot03PalLen); }
	
	for (int i = 0; i < 2; i++) { swiWaitForVBlank(); }

	swiDecompressLZSSVram ((void*)Top03Tiles, (void*)CHAR_BASE_BLOCK(2), 0, &decompressBiosCallback);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)Bot03Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	vramcpy_ui (&BG_PALETTE[0], Top04Pal, Top04PalLen);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], Bot04Pal, Bot04PalLen); }

	for (int i = 0; i < 2; i++) { swiWaitForVBlank(); }

	swiDecompressLZSSVram ((void*)Top04Tiles, (void*)CHAR_BASE_BLOCK(2), 0, &decompressBiosCallback);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)Bot04Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	...
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)Bot05Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	vramcpy_ui (&BG_PALETTE[0], Top05Pal, Top05PalLen);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], Bot05Pal, Bot05PalLen); }
	...
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)Bot06Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	vramcpy_ui (&BG_PALETTE[0], Top32Pal, Top32PalLen);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], Bot06Pal, Bot06PalLen); }

	for (int i = 0; i < 2; i++) { swiWaitForVBlank(); }
	
	swiDecompressLZSSVram ((void*)Top33Tiles, (void*)CHAR_BASE_BLOCK(2), 0, &decompressBiosCallback);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)Bot07Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	vramcpy_ui (&BG_PALETTE[0], Top33Pal, Top33PalLen);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], Bot07Pal, Bot07PalLen); }

	for (int i = 0; i < 2; i++) { swiWaitForVBlank(); }	

	swiDecompressLZSSVram ((void*)Top34Tiles, (void*)CHAR_BASE_BLOCK(2), 0, &decompressBiosCallback);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)Bot08Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	vramcpy_ui (&BG_PALETTE[0], Top34Pal, Top34PalLen);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], Bot08Pal, Bot08PalLen); }

	for (int i = 0; i < 2; i++) { swiWaitForVBlank(); }

	swiDecompressLZSSVram ((void*)Top35Tiles, (void*)CHAR_BASE_BLOCK(2), 0, &decompressBiosCallback);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)Bot09Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	vramcpy_ui (&BG_PALETTE[0], Top35Pal, Top35PalLen);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], Bot09Pal, Bot09PalLen); }

	for (int i = 0; i < 2; i++) { swiWaitForVBlank(); }

	swiDecompressLZSSVram ((void*)Top36Tiles, (void*)CHAR_BASE_BLOCK(2), 0, &decompressBiosCallback);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { swiDecompressLZSSVram ((void*)Bot10Tiles, (void*)CHAR_BASE_BLOCK_SUB(2), 0, &decompressBiosCallback); }
	vramcpy_ui (&BG_PALETTE[0], Top36Pal, Top36PalLen);
	if(ntrlauncher_config.GetInt("NTR-FORWARDER","HEALTH&SAFETY_MSG",0) == 1) { vramcpy_ui (&BG_PALETTE_SUB[0], Bot10Pal, Bot10PalLen); }
